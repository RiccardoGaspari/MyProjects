...
#define GRAPH
    ...
    CreateGraph("ARMA_30_10_Bin_AllCNN",
        /* Arguments either passed or globals */
            CArgs(20,
                ...
                // in: 0.00176 out: 0.00176  actscale: [1] actscalen: [0] a0: [0] b0: 0 c0: 0 BIASN: 0 PRENORM: 0 NE16_PADVAL: [124] NE16_WOFFSET: [-128]
                ...
                // in: 0.00339 out: 0.00339  actscale: [1] actscalen: [0] a0: [0] b0: 0 c0: 0 BIASN: 0 PRENORM: 0 NE16_PADVAL: [0] NE16_WOFFSET: [-128]
                ...
                // no activation ACTSCALE: 0 ACTSCALEN: 0 GLOBAL_SUM_SCALE: [155] GLOBAL_SUM_SCALEN: [12]
                ...
                // in q: -0.09<(i8-0.00)*0.00069781<0.09 out_q: 0.00<(u8-0.00)*0.00034754<0.09
                ...
                // in: 0.00195 out: 0.00003  BIASL_SM: [6]
    ...
    // Node S3_ARMA_30_10_Bin_All_conv2d_Conv2D_fusion inq -0.92<(u8-124.00)*0.00738862<0.97 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.00175668<0.45 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S6_ARMA_30_10_Bin_All_conv2d_1_Conv2D_fusion inq 0.00<(u8-0.00)*0.00175668<0.45 weightsq chan<(u8-128.00)*chan<chan outq -0.43<(i8-0.00)*0.00338614<0.43 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node ARMA_30_10_Bin_All_conv2d_1_Conv2D_fusion_trans_out0 inq -0.43<(i8-0.00)*0.00338614<0.43 outq -0.43<(i8-0.00)*0.00338614<0.43
    ...
    // Node ARMA_30_10_Bin_All_global_average_pooling2d_Mean inq -0.43<(i8-0.00)*0.00338614<0.43 outq -0.09<(i8-0.00)*0.00069781<0.09
    ...
    // Node ARMA_30_10_Bin_All_global_average_pooling2d_Mean_qout0 inq -0.09<(i8-0.00)*0.00069781<0.09 outq 0.00<(u8-0.00)*0.00034754<0.09
    ...
    // Node ARMA_30_10_Bin_All_dense_MatMul inq 0.00<(u8-0.00)*0.00034754<0.09 weightsq chan<(u8-128.00)*chan<chan outq -0.25<(i8-0.00)*0.00195312<0.25 forced
    ...
    // Node ARMA_30_10_Bin_All_dense_Softmax inq -0.25<(i8-0.00)*0.00195312<0.25 forced outq -1.00<(i16-0.00)*0.00003052<1.00
