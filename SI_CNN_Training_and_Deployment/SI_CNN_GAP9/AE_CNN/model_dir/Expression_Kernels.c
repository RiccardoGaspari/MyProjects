...
void s24_kernel(s24_kernel_args_t * __restrict__ Args) {
    unsigned int I0 = Args->I0;
    unsigned char *__restrict__  expr_1_in_0 = Args->expr_1_in_0; // (1, 256, 2) (uint8-180) 1.204 Q8
    unsigned char *__restrict__  expr_1_in_1 = Args->expr_1_in_1; // (1, 256, 2) uint8 0.244 Q8
    unsigned char *__restrict__  expr_1_out_0 = Args->expr_1_out_0; // (1, 256, 2) (uint8-158) 0.489 Q7
    unsigned int CoreId = gap_coreid();
    unsigned int Chunk = ChunkSize(I0);
    unsigned int First = Chunk*CoreId;
    unsigned int Last = gap_min(First+Chunk, I0);
    ...
    // Interior spaces ()
    for (int i0=First; i0<Last; i0++) {
        // inputs expr_1_in_0: (uint8-180) 1.204 Q8 expr_1_in_1: uint8 0.244 Q8
        // expr_1_out_0 = Cast(Clip(Sub(Norm(Mul(Add(Norm(Mul(Cast(expr_1_in_0, int32), [158]), [5]), Cast(expr_1_in_1, int32)), [255]), [10]), [63]), 0, 255), uint8)
        // _encoder_conv_conv_1_Add scale arg 1 (no zp adj) - uint8 0.244 Q8 -> int32 1.953 Q11
        int _SYMBOL_Cast4 = ((int)expr_1_in_1[i0]);
        // scale clip and cast - (int32-889) 3.906 Q12 -> (uint8-158) 0.489 Q7
        expr_1_out_0[i0] = ((unsigned char)gap_clipu(((gap_roundnorm_reg(((gap_roundnorm_reg((((int)expr_1_in_0[i0])*(158)), ((unsigned char)5))+_SYMBOL_Cast4)*(255)), ((unsigned char)10))-(63))), (((signed char)8))));
    }
    gap_waitbarrier(0);
}
...
void s37_kernel(s37_kernel_args_t * __restrict__ Args) {
    ...
    unsigned char *__restrict__  expr_2_out_0 = Args->expr_2_out_0; // (1, 128, 4) (uint8-253) 0.299 Q7
    unsigned int CoreId = gap_coreid();
    unsigned int Chunk = ChunkSize(I0);
    unsigned int First = Chunk*CoreId;
    unsigned int Last = gap_min(First+Chunk, I0);
    ...
    for (int i0=First; i0<Last; i0++) {
        ...
        // expr_2_out_0 = Cast(Clip(Sub(Norm(Mul(Add(Norm(Mul(Cast(expr_2_in_0, int32), [203]), [5]), Cast(expr_2_in_1, int32)), [169]), [10]), [14]), 0, 255), uint8)
        // _encoder_conv_conv_2_Add scale arg 1 (no zp adj) - uint8 0.099 Q8 -> int32 0.790 Q11
        int _SYMBOL_Cast7 = ((int)expr_2_in_1[i0]);
        // scale clip and cast - (int32-1618) 1.580 Q12 -> (uint8-253) 0.299 Q7
        expr_2_out_0[i0] = ((unsigned char)gap_clipu(((gap_roundnorm_reg(((gap_roundnorm_reg((((int)expr_2_in_0[i0])*(203)), ((unsigned char)5))+_SYMBOL_Cast7)*(169)), ((unsigned char)10))-(14))), (((signed char)8))));
    }
    gap_waitbarrier(0);
}
...
void s50_kernel(s50_kernel_args_t * __restrict__ Args) {
    unsigned int I0 = Args->I0;
    unsigned char *__restrict__  expr_3_in_0 = Args->expr_3_in_0; // (1, 64, 32) (uint8-116) 1.041 Q8
    ...
    // Interior spaces ()
    for (int i0=First; i0<Last; i0++) {
        // inputs expr_3_in_0: (uint8-116) 1.041 Q8 expr_3_in_1: uint8 0.182 Q8
        ...
        // _encoder_conv_conv_3_Add scale arg 1 (no zp adj) - uint8 0.182 Q8 -> int32 1.455 Q11
        int _SYMBOL_Cast10 = ((int)expr_3_in_1[i0]);
        // scale clip and cast - (int32-663) 2.909 Q12 -> (uint8-108) 0.537 Q7
...
void s60_kernel(s60_kernel_args_t * __restrict__ Args) {
    ...
    unsigned char *__restrict__  expr_4_in_1 = Args->expr_4_in_1; // (1, 32, 32) (uint8-128) 0.600 Q8
    ...
    // Interior spaces ()
    for (int i0=First; i0<Last; i0++) {
        // inputs expr_4_in_0: uint8 0.143 Q8 expr_4_in_1: (uint8-128) 0.600 Q8
        // expr_4_out_0 = Cast(Clip(Sub(Norm(Mul(Add(Cast(expr_4_in_0, int32), Norm(Mul(Cast(expr_4_in_1, int32), [134]), [5])), [224]), [10]), [-1]), 0, 255), uint8)
        // _decoder_deconv_deconv_0_Add scale arg 0 (no zp adj) - uint8 0.143 Q8 -> int32 1.143 Q11
        int _SYMBOL_Cast12 = ((int)expr_4_in_0[i0]);
        // scale clip and cast - (int32-536) 2.286 Q12 -> (uint8-118) 0.326 Q7
        expr_4_out_0[i0] = ((unsigned char)gap_clipu(((gap_roundnorm_reg(((_SYMBOL_Cast12+gap_roundnorm_reg((((int)expr_4_in_1[i0])*(134)), ((unsigned char)5)))*(224)), ((unsigned char)10))-(-1))), (((signed char)8))));
    }
    gap_waitbarrier(0);
}
...
void s70_kernel(s70_kernel_args_t * __restrict__ Args) {
    ...
    for (int i0=First; i0<Last; i0++) {
        ...
        // _decoder_deconv_deconv_1_Add scale arg 0 (no zp adj) - uint8 0.163 Q8 -> int32 0.651 Q10
