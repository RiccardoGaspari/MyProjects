...
AT_DEFAULTFLASH_EXT_ADDR_TYPE ARMA_50_30_Bin_All_L3_Flash = 0;
...
static void cluster(void * arg)
{
    ...
    ARMA_50_30_Bin_AllCNN_ConstructCluster();
GPIO_HIGH();
    ARMA_50_30_Bin_AllCNN(Input_1, Output_1);
GPIO_LOW();
...
{
    printf("\n\n\t *** NNTOOL ARMA_50_30_Bin_All Example ***\n\n");
    ...
    printf("Constructor\n");
    int ConstructorErr = ARMA_50_30_Bin_AllCNN_Construct();
    if (ConstructorErr)
    {
    ...
    ARMA_50_30_Bin_AllCNN_Destruct();
