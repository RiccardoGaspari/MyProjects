...
#define GRAPH
    ...
    CreateGraph("AE_1dcnn_RELUCNN",
        /* Arguments either passed or globals */
            CArgs(147,
                ...
                // in: 0.00825 out: 0.00825  actscale: [1] actscalen: [0] a0: [0] b0: 0 c0: 0 BIASN: 0 PRENORM: 0
                ...
                // in: 0.00045 out: 0.00045  actscale: [1] actscalen: [0] a0: [0] b0: 0 c0: 0 BIASN: 0 PRENORM: 0 NE16_PADVAL: [62] NE16_WOFFSET: [-128]
                ...
                // no activation BIASN: 0 PRENORM: 0 NE16_PADVAL: [62] NE16_WOFFSET: [-128]
                ...
                // no activation BIASN: 0 PRENORM: 0 NE16_PADVAL: [158] NE16_WOFFSET: [-128]
                ...
                // in: 0.00011 out: 0.00011  actscale: [1] actscalen: [0] a0: [0] b0: 0 c0: 0 BIASN: 0 PRENORM: 0 NE16_PADVAL: [222] NE16_WOFFSET: [-128]
                ...
                // no activation BIASN: 0 PRENORM: 0 NE16_PADVAL: [222] NE16_WOFFSET: [-128]
                ...
                // no activation BIASN: 0 PRENORM: 0 NE16_PADVAL: [253] NE16_WOFFSET: [-128]
    ...
    // Node S4__encoder_conv_conv_0_backbone_backbone_0_backbone_0_0_Conv_fusion inq -1.00<(i8-0.00)*0.00781249<0.99 forced weightsq -0.48<(i8-0.00)*0.00376900<0.48 outq -1.06<(i8-0.00)*0.00824548<1.05 forced biasesq -63233.34<(i32-0.00)*0.00002945<63233.34
    ...
    // Node S7__encoder_conv_conv_0_backbone_backbone_1_backbone_1_0_Conv_fusion inq -1.06<(i8-0.00)*0.00824548<1.05 forced weightsq -0.31<(i8-0.00)*0.00245083<0.31 outq 0.00<(i8--128.00)*0.00392157<1.00 biasesq -43397.04<(i32-0.00)*0.00002021<43397.04
    ...
    // Node S10__encoder_conv_conv_0_projection_Conv inq -1.00<(i8-0.00)*0.00781249<0.99 forced weightsq -0.02<(i8-0.00)*0.00013640<0.02 outq -0.68<(i8-127.00)*0.00265822<0.00 biasesq -2288.44<(i32-0.00)*0.00000107<2288.44
    ...
    // Node S14__encoder_conv_conv_0_downsampling_Conv inq -0.68<(i8-0.00)*0.00529567<0.67 forced weightsq -0.35<(i8-0.00)*0.00277704<0.35 outq -0.14<(u8-62.00)*0.00225063<0.43 biasesq -31581.48<(i32-0.00)*0.00001471<31581.48
    ...
    // Node S17__encoder_conv_conv_1_backbone_backbone_0_backbone_0_0_Conv_fusion inq -0.14<(u8-62.00)*0.00225063<0.43 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.00044875<0.11 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S20__encoder_conv_conv_1_backbone_backbone_1_backbone_1_0_Conv_fusion inq 0.00<(u8-0.00)*0.00044875<0.11 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.00095368<0.24 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S23__encoder_conv_conv_1_projection_Conv inq -0.14<(u8-62.00)*0.00225063<0.43 weightsq chan<(u8-128.00)*chan<chan outq -0.85<(u8-180.00)*0.00470489<0.35 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node expr_1 in_qs [-0.85<(u8-180.00)*0.00470489<0.35,0.00<(u8-0.00)*0.00095368<0.24] out_qs [-0.60<(u8-158.00)*0.00382398<0.37]
    AddNode("S24_expr_1",
        Bindings(3,
    ...
    // Node S27__encoder_conv_conv_1_downsampling_Conv inq -0.60<(u8-158.00)*0.00382398<0.37 weightsq chan<(u8-128.00)*chan<chan outq -0.53<(u8-222.00)*0.00238334<0.08 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S30__encoder_conv_conv_2_backbone_backbone_0_backbone_0_0_Conv_fusion inq -0.53<(u8-222.00)*0.00238334<0.08 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.00011089<0.03 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S33__encoder_conv_conv_2_backbone_backbone_1_backbone_1_0_Conv_fusion inq 0.00<(u8-0.00)*0.00011089<0.03 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.00038567<0.10 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S36__encoder_conv_conv_2_projection_Conv inq -0.53<(u8-222.00)*0.00238334<0.08 weightsq chan<(u8-128.00)*chan<chan outq -0.62<(u8-255.00)*0.00244318<0.00 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node expr_2 in_qs [-0.62<(u8-255.00)*0.00244318<0.00,0.00<(u8-0.00)*0.00038567<0.10] out_qs [-0.59<(u8-253.00)*0.00233735<0.00]
    AddNode("S37_expr_2",
        Bindings(3,
    ...
    // Node S40__encoder_conv_conv_2_downsampling_Conv inq -0.59<(u8-253.00)*0.00233735<0.00 weightsq chan<(u8-128.00)*chan<chan outq -0.41<(u8-255.00)*0.00161934<0.00 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S43__encoder_conv_conv_3_backbone_backbone_0_backbone_0_0_Conv_fusion inq -0.41<(u8-255.00)*0.00161934<0.00 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.00157512<0.40 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S46__encoder_conv_conv_3_backbone_backbone_1_backbone_1_0_Conv_fusion inq 0.00<(u8-0.00)*0.00157512<0.40 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.00071022<0.18 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S49__encoder_conv_conv_3_projection_Conv inq -0.41<(u8-255.00)*0.00161934<0.00 weightsq chan<(u8-128.00)*chan<chan outq -0.47<(u8-116.00)*0.00406542<0.57 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node expr_3 in_qs [-0.47<(u8-116.00)*0.00406542<0.57,0.00<(u8-0.00)*0.00071022<0.18] out_qs [-0.45<(u8-108.00)*0.00419490<0.62]
    AddNode("S50_expr_3",
        Bindings(3,
    ...
    // Node S53__encoder_conv_conv_3_downsampling_Conv inq -0.45<(u8-108.00)*0.00419490<0.62 weightsq chan<(u8-128.00)*chan<chan outq -0.30<(u8-128.00)*0.00234274<0.30 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S56__decoder_deconv_deconv_0_backbone_backbone_0_backbone_0_0_ConvTranspose_fusion inq -0.30<(u8-128.00)*0.00234274<0.30 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.00070311<0.18 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S59__decoder_deconv_deconv_0_backbone_backbone_1_backbone_1_0_ConvTranspose_fusion inq 0.00<(u8-0.00)*0.00070311<0.18 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.00055805<0.14 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node expr_4 in_qs [0.00<(u8-0.00)*0.00055805<0.14,-0.30<(u8-128.00)*0.00234274<0.30] out_qs [-0.30<(u8-118.00)*0.00254671<0.35]
    AddNode("S60_expr_4",
        Bindings(3,
    ...
    // Node S63__decoder_deconv_deconv_0_upsampling_ConvTranspose inq -0.30<(u8-118.00)*0.00254671<0.35 weightsq chan<(u8-128.00)*chan<chan outq -0.21<(u8-138.00)*0.00151501<0.18 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S66__decoder_deconv_deconv_1_backbone_backbone_0_backbone_0_0_ConvTranspose_fusion inq -0.21<(u8-138.00)*0.00151501<0.18 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.00091170<0.23 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S69__decoder_deconv_deconv_1_backbone_backbone_1_backbone_1_0_ConvTranspose_fusion inq 0.00<(u8-0.00)*0.00091170<0.23 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.00063527<0.16 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node expr_5 in_qs [0.00<(u8-0.00)*0.00063527<0.16,-0.21<(u8-138.00)*0.00151501<0.18] out_qs [-0.21<(u8-111.00)*0.00188757<0.27]
    AddNode("S70_expr_5",
        Bindings(3,
    ...
    // Node S73__decoder_deconv_deconv_1_upsampling_ConvTranspose inq -0.21<(u8-111.00)*0.00188757<0.27 weightsq chan<(u8-128.00)*chan<chan outq -0.19<(u8-147.00)*0.00131983<0.14 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S76__decoder_deconv_deconv_2_backbone_backbone_0_backbone_0_0_ConvTranspose_fusion inq -0.19<(u8-147.00)*0.00131983<0.14 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.00066236<0.17 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S79__decoder_deconv_deconv_2_backbone_backbone_1_backbone_1_0_ConvTranspose_fusion inq 0.00<(u8-0.00)*0.00066236<0.17 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.00050988<0.13 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node expr_6 in_qs [0.00<(u8-0.00)*0.00050988<0.13,-0.19<(u8-147.00)*0.00131983<0.14] out_qs [-0.19<(u8-115.00)*0.00168136<0.24]
    AddNode("S80_expr_6",
        Bindings(3,
    ...
    // Node S83__decoder_deconv_deconv_2_upsampling_ConvTranspose inq -0.19<(u8-115.00)*0.00168136<0.24 weightsq chan<(u8-128.00)*chan<chan outq -0.17<(u8-114.00)*0.00147047<0.21 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S86__decoder_deconv_deconv_3_backbone_backbone_0_backbone_0_0_ConvTranspose_fusion inq -0.17<(u8-114.00)*0.00147047<0.21 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.00054041<0.14 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S89__decoder_deconv_deconv_3_backbone_backbone_1_backbone_1_0_ConvTranspose_fusion inq 0.00<(u8-0.00)*0.00054041<0.14 weightsq chan<(u8-128.00)*chan<chan outq 0.00<(u8-0.00)*0.00063630<0.16 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node expr_7 in_qs [0.00<(u8-0.00)*0.00063630<0.16,-0.17<(u8-114.00)*0.00147047<0.21] out_qs [-0.09<(u8-60.00)*0.00147528<0.29]
    AddNode("S90_expr_7",
        Bindings(3,
    ...
    // Node S93__decoder_deconv_deconv_3_upsampling_ConvTranspose inq -0.09<(u8-60.00)*0.00147528<0.29 weightsq chan<(u8-128.00)*chan<chan outq -0.26<(u8-134.00)*0.00191536<0.23 biasesq chan<(i32-0.00)*chan<chan
    ...
    // Node S96__decoder_deconv_deconv_4_Conv inq -0.26<(u8-134.00)*0.00191536<0.23 weightsq -0.13<(u8-128.00)*0.00104405<0.13 outq -0.13<(u8-128.00)*0.00100150<0.13 forced biasesq -4294.40<(i32-0.00)*0.00000200<4294.40
