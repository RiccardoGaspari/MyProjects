...
AT_DEFAULTFLASH_EXT_ADDR_TYPE ARMA_30_10_Bin_All_L3_Flash = 0;
...
/* Inputs */
L2_MEM unsigned char Input_1[20];
/* Outputs */
...
int copy_inputs(int num_iterations) {
    {
        ...
        ret_Input_1 = __READ(Input_File_Input_1, Input_1, 20);
        if (ret_Input_1 != 20) {
            return 0;
        }
        Input_File_Input_1_Position = 0;
...
static void cluster(void * arg)
{
    ...
    ARMA_30_10_Bin_AllCNN_ConstructCluster();
GPIO_HIGH();
    ARMA_30_10_Bin_AllCNN(Input_1, Output_1);
GPIO_LOW();
...
int main(int argc, char *argv[])
{
  ...
  gv_trace_enable("fc/insn:log");
    ...
    printf("\n\n\t *** NNTOOL ARMA_30_10_Bin_All Example ***\n\n");
    ...
    printf("Constructor\n");
    int ConstructorErr = ARMA_30_10_Bin_AllCNN_Construct();
    if (ConstructorErr)
    {
    ...
    ARMA_30_10_Bin_AllCNN_Destruct();
