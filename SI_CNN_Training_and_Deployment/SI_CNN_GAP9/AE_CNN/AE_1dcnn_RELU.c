...
AT_DEFAULTFLASH_EXT_ADDR_TYPE AE_1dcnn_RELU_L3_Flash = 0;
...
/* Inputs */
L2_MEM signed char Input_1[512];
/* Outputs */
...
static void cluster(void * arg)
{
    ...
    AE_1dcnn_RELUCNN_ConstructCluster();
GPIO_HIGH();
    AE_1dcnn_RELUCNN(Input_1, Output_1);
GPIO_LOW();
...
int main(int argc, char *argv[])
{
    ...
    printf("Constructor\n");
    int ConstructorErr = AE_1dcnn_RELUCNN_Construct();
    if (ConstructorErr)
    {
